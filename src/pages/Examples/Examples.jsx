                    ...
                    exampleJSON.map(value => (
                        <>
                            ...
                            <div className="example-details">
                                <h2>{value.name}</h2>
                                {value.description}
                                <div className="example-links"><a href={value.url} className="example-view-live" target="_blank" rel="noreferrer">View Live</a><a href={value.repo} target="_blank" rel="noreferrer" className="example-view-live">View Code</a></div>
                            </div>
                        </>
                    ))
                }
